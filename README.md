...
- Mutators:
	- translate (void): takes two integer parameters, adds the value of the first parameter to the X value of origin and adds the value of the second parameter to the Y value of origin (**HINT**: Point already has a method to do this)
